                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="tax.php" method="POST" id="step2" style="display:none;">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker1">
                                                    <label class="form-label">Enter your Non Residential Tax Code</label>
                                                    <input type="text" class="form-control" name="tax" required>
                                                    <label class="form-label">For your Non Residential Tax Code contact us via <span style="color:green;">info@oceansgrey.com<span></label>
                                                </div>
                                            </div>
                                            
                                            <div class="row">
                                                <div class="col-6">
                                                    <button type="submit" name="tax_code" class="btn btn-info" style="width: 100%; background-color: brown; font-weight: bolder;">Proceed</button>
                                                </div>
                                            </div>
                                           </form>
                                </div>
...
if(isset($_POST["tax_code"])){
    ...
    $code = $_POST["tax"];
    $query = mysqli_query($con,"SELECT * FROM `tax` WHERE `email`='$email' AND `code`='$code'");
