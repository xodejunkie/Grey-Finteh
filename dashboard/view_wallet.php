                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">STP Wallet</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">STP Wallet Details</h4>
                                        <?php
                                        $query_qr = mysqli_query($con,"SELECT * FROM `wallet` WHERE 1");
                                        $link_qr = mysqli_fetch_assoc($query_qr);
                                        echo'
                                        <img src="image/'.$link_qr["photo"].'" style="width:250px;" />
                                       <h5>'.$link_qr["wallet"].'</h5>
                                        ';
                                        ?>
