                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="imf.php" method="POST" id="step2" style="display:none;">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker1">
                                                    <label class="form-label">Enter your IMF CODE</label>
                                                    <input type="text" class="form-control" name="imf" required>
                                                    <label class="form-label">For your IMF CODE contact us via <span style="color:green;">info@oceansgrey.com<span></label>
                                                </div>
                                            </div>
                                            
                                            <div class="row">
                                                <div class="col-6">
                                                    <button type="submit" name="imf_code" class="btn btn-info" style="width: 100%; background-color: brown; font-weight: bolder;">Proceed</button>
                                                </div>
                                            </div>
                                           </form>
                                </div>
...
<?php
if(isset($_POST["imf_code"])){
    $email = $_SESSION["email"];
    $code = $_POST["imf"];
    $query = mysqli_query($con,"SELECT * FROM `imf` WHERE `email`='$email' AND `code`='$code'");
