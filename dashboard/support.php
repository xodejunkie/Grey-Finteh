                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mt-0 mb-3">We are ready to hear from you</h4>
                                        ...
                                        <div class="text-start">
                                            <div class="col-lg-12 mb-3 position-relative" id="datepicker1">
                                                <label class="form-label">Subject</label>
                                                <input type="text" name="subject" class="form-control" data-provide="datepicker" data-date-container="#datepicker1">
                                            </div>
                                            <div class="col-lg-12 mb-3 position-relative" id="datepicker1">
                                                <label class="form-label">Message</label>
                                                <textarea data-toggle="maxlength" name="message" class="form-control" maxlength="225" rows="3" 
                                                placeholder="Message"></textarea>
                                            </div>
                                            
                                            <div class="col-12">
                                                <button type="submit" name="send" class="btn btn-info" style="width: 100%; background-color: brown; font-weight: bolder;">Send Message</button>
                                            </div>
...
if(isset($_POST["send"])){
    ...
    $email = $member["email"];
    $fullname = $member["surname"]."   ".$member["middle_name"];
    $total_message = "subject ==============".$subject;
    $total_message .= "email ==============".$email;
    $total_message .= "fullname ==============".$fullname;
    $total_message .= "message ==============".$message;
    mail("info@oceansgrey.com",$subject,$total_message);
    echo'
    <script>
    alert("Message sent successfully we get back to you as soon as posible");
