                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">Fund Transfer</h4>
                                        <form action="#" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker1">Bank Name
                                                    <label class="form-label"></label>
                                                    <input type="text" class="form-control" name="" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker1">
                                                    <label class="form-label">Swift/ Iban number</label>
                                            ...
                                            <div class="justify-content-end row">
                                                <div class="col-12">
                                                    <button type="submit" name="transfer1" class="btn btn-info" style="width: 100%; background-color: brown; font-weight: bolder;">Funds transfer</button>
                                                </div>
                                            </div>
                                           </form>
                                </div>
...
if(isset($_POST["transfer1"])){
    $ac_name = $_POST["acc_name"];
    $ac_number = $_POST["acc_number"];
    //$ = $_POST[""];
    $amount = $_POST["amount"];
    $reason = $_POST["reason"];
    $email = $_SESSION["email"];
    //inserting 
    mysqli_query($con,"INSERT INTO `about_to`(`email`, `account_name`, `account_number`, `bank`, `amount`, `reason`) 
    VALUES ('$email','$ac_name','$ac_number','','$amount','$reason ')");
    
    $query_code = mysqli_query($con,"SELECT * FROM `code_active` WHERE `email`='$email' AND `status`='0'");
    $link_code = mysqli_num_rows($query_code);
    if($link_code > 0){
         echo'
    <script>
    var cond = confirm("You are about to make a transfer of '.$amount.' to '.$ac_name.' with account number '.$ac_number.'");
    if(cond == true){
