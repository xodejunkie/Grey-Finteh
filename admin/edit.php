                                        ...
                                        <form action="edit.php" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    ...
                                                    <input type="text" class="form-control" name="surname" value="'.$link["surname"].'" required>
                                                    <input type="hidden" class="form-control" name="email" value="'.$link["email"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Middle Name</label>
                                                    <input type="text" class="form-control" name="middle_name" value="'.$link["middle_name"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Other Name</label>
                                                    <input type="text" class="form-control" name="other_name" value="'.$link["other_name"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Job Title</label>
                                                    <input type="text" class="form-control" name="job_title" value="'.$link["job_title"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Marital Status</label>
                                                    <input type="text" class="form-control" name="status" value="'.$link["marital_status"].'" required>
                                                </div>
                                                ';
                                                ?>
...
if(isset($_POST["update"])){
    ...
    $status  = $_POST["status"];
    $email  = $_POST["email"];
    mysqli_query($con,"UPDATE `customer` SET `surname`='$surname',`middle_name`='$middle_name',`other_name`='$other_name',`job_title`='$job_title',`marital_status`='$status' WHERE `email`='$email'");
    echo'
    <script>
