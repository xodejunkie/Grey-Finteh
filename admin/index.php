...
$query = $con->query("SELECT fullname, email, job_title, marital_status FROM users ORDER BY id DESC LIMIT $offset, $results_per_page");
?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="width:14.28%;">Full Name</th>
                                    <th style="width:14.28%;">Email</th>
                                    <th style="width:14.28%;">Job title</th>
                                    <th style="width:14.28%;">Marital status</th>
                            ...
                            <tbody>
                                ...
                                while ($link = $query->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <td>'.$link["marital_status"].'</td>
                                    <td class="table-action">
                                        <a href="delete.php?email='.$link["email"].'">Delete</a>
                                        <a href="edit.php?email='.$link["email"].'">Edit</a>
                                    </td>
                                    </tr>
                                    ';
                                }
