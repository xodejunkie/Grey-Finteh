                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="edit_details.php" method="POST">
                                            ...
                                            <div class="row">
                                                <?php
                                                $email = $_GET["email"];
                                                $query = mysqli_query($con,"SELECT * FROM `contact_details` WHERE `email`='$email'");
                                                $link = mysqli_fetch_assoc($query);
                                                echo'
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Phone Number</label>
                                                    <input type="text" class="form-control" name="phone" value="'.$link["phone"].'" required>
                                                    <input type="hidden" class="form-control" name="email" value="'.$link["email"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Home Address</label>
                                                    <input type="text" class="form-control" name="home" value="'.$link["home"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">City</label>
                                                    <input type="text" class="form-control" name="city" value="'.$link["city"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">state</label>
                                                    <input type="text" class="form-control" name="state" value="'.$link["state"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">MarZip code</label>
                                                    <input type="text" class="form-control" name="zip_code" value="'.$link["zip_code"].'" required>
                                                </div>
                                                <div class="col-lg-6 mb-3 position-relative" id="datepicker2">
                                                    <label class="form-label">Country</label>
                                                    <input type="text" class="form-control" name="country" value="'.$link["country"].'" required>
                                                </div>
                                                ';
                                                ?>
...
if(isset($_POST["update"])){
    ...
    $email  = $_POST["email"];
    mysqli_query($con,"UPDATE `contact_details` SET `phone`='$phone',`home`='$home',`city`='$city',`state`='$state',`zip_code`='$zip_code',`country`='$country' WHERE `email`='$email'");
    echo'
    <script>
